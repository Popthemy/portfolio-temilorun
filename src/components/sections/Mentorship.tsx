...
export const Mentorship: React.FC = () => {
  ...
  return (
    <section
      id="mentorship"
      className="py-32 bg-dark dark:bg-slate-950 text-white relative overflow-hidden transition-colors duration-300"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-24 items-center">
          ...
          >
            <h2 className="text-5xl font-display font-medium mb-8 tracking-tight">
            ...
            >
              ...
              >
                <div className="bg-primary/20 p-4 rounded-2xl text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500">
                  <Users size={32} />
                </div>
                <div>
