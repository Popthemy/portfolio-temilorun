  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        >
          <motion.div variants={itemVariants} className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-6">
            ...
            <div className="md:hidden flex items-center gap-2 px-3 py-1.5 bg-green-50 rounded-full border border-green-100">
              ...
              <span className="text-[10px] font-bold text-green-700 uppercase tracking-wider">Available for work</span>
            </div>
          </motion.div>
          <motion.h1 variants={itemVariants} className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-medium leading-[0.9] tracking-tighter flex flex-col items-center md:items-start">
          ...
          <motion.p variants={itemVariants} className="mt-8 text-lg md:text-xl text-gray-600 dark:text-gray-400 max-w-lg mx-auto md:mx-0 leading-relaxed">
            Building secure automation from Ibadan, Nigeria. Reliable code that scales and saves time.
          </motion.p>
          <motion.p variants={itemVariants} className="mt-4 text-base md:text-lg font-medium text-dark dark:text-gray-200">
            Efficiency matters. I deliver solutions that work—end to end.
          </motion.p>
          <motion.div variants={itemVariants} className="mt-10 md:mt-12 flex flex-col sm:flex-row gap-6 items-center justify-center md:justify-start">
            <MagneticButton 
              href="#projects" 
            ...
            <div className="flex space-x-6 items-center">
              <a href="#" aria-label="GitHub Profile" className="text-gray-400 hover:text-primary transition-all hover:scale-110"><Github size={28} /></a>
              <a href="#" aria-label="LinkedIn Profile" className="text-gray-400 hover:text-primary transition-all hover:scale-110"><Linkedin size={28} /></a>
            </div>
          </motion.div>
        </motion.div>
            ...
            <div className="relative w-full max-w-sm lg:max-w-md mx-auto group">
              ...
              >
                <motion.img 
                  ...
                  src="https://picsum.photos/seed/popoola/800/800" 
              ...
              >
                ...
                <p className="text-[8px] md:text-[9px] text-gray-400 dark:text-gray-500 uppercase font-bold tracking-[0.2em] mb-0.5 md:mb-1">Status</p>
                <p className="text-[9px] md:text-[11px] font-bold text-dark dark:text-white uppercase tracking-widest text-center px-2 md:px-4 leading-tight">Available for work</p>
